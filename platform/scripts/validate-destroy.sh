#!/bin/bash
# Terraform Destroy Plan Validator (canonical implementation)
#
# This script was consolidated from scripts/validate-destroy.sh.
# The top-level wrapper now delegates here:
#   - scripts/validate-destroy.sh → platform/scripts/validate-destroy.sh
#
# Validates a Terraform destroy plan before execution:
#   - Confirms a valid plan file is provided
#   - Ensures the plan is a destroy plan
#   - Highlights critical/sensitive deletions
#   - Provides human-readable impact analysis
#
# Usage:
#   terraform plan -destroy -out=tfplan
#   platform/scripts/validate-destroy.sh tfplan
