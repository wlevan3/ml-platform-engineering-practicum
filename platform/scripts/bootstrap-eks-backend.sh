...
#
# Usage:
#   ./platform/scripts/bootstrap-eks-backend.sh [profile]
#
# Examples:
#   ./platform/scripts/bootstrap-eks-backend.sh           # Uses default AWS profile
#   ./platform/scripts/bootstrap-eks-backend.sh dev       # Uses 'dev' profile
#
# Cost:
