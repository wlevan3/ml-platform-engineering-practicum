"""Security utilities for the ML platform API.

Canonical location for security helpers; services.api.security is a shim that
re-exports from this module as part of the STREAMLINING_PLAN migration.
"""
